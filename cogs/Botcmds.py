...
class Commands(commands.Cog):
    ...
    async def membercount(self, inter):
        ...
        embed.add_field(
            name="Members of Silico Battles",
    ...
    async def botinfo(self, inter):
        ...
        embed = disnake.Embed(
            title="Sico Information: ", description=" ", color=0xFFFFFF
        )
        embed.add_field(name="**Bot Name: **", value=f"```>> Sico```", inline=False)
        embed.add_field(
            name="**Bot Version: **",
            value=f"```>> {__VERSION__}```",
            inline=False,
        ...
        embed.add_field(
            name="**Bot Developers: **",
            value=f"`>`[**Mahesh**](https://github.com/MaheshDhingra)\n",
            inline=False,
        )
        embed.set_thumbnail(
        ...
        button = disnake.ui.Button(
            ...
            url="https://github.com/SilicoBattles/Sico",
        )
