...
class LevelsController:
    def __init__(self, bot: Sico, db: async_sessionmaker[AsyncSession]):
        self.bot = bot
        self.db = db
...
class Level(commands.Cog):
    ...
    async def edit_custom_role(
        self,
        inter: ApplicationCommandInteraction,
        color: str | None = commands.Param(
            description="The hex color of the role. Make it different from staff role colors.",
            default=None,
        ),
        name: str | None = commands.Param(
            description="The name of the role. Dont impersonate staff",
            default=None,
        ),
        icon: str | None = commands.Param(
    ...
    async def check_roles(
        self,
        inter: ApplicationCommandInteraction,
        member: Member | None = commands.Param(
            description="Optionally specify member", default=None
        ),
    ):
